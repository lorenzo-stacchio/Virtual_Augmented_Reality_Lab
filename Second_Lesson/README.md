...
To export your application in an android device, you have to select a valid SDK and JDK from the Unity Menu. The JDK should be delivered with Unity installation if you picked the "Android support" option when you installed it.   
...
Once the Android sdk is installed in your system, you could deploy your application to an android device.